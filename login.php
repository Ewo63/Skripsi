...
<html>
  <head>
    ...
    <title>Sistem Informasi Penilaian Siswa | Log in</title>
   <link rel="shortcut icon" href="dist/img/avicon.ico">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><p>SISTEM INFORMASI PENGOLAHAN NILAI SISWA</p> SDN 1 TAMBAKSARI</a>
      </div><!-- /.login-logo -->
